...
function RegistrationForm({ onRegister }) {
  ...
  const handleTermsClick = () => {
    ...
    <div class="terms-content">
      ...
      <p>Welcome to Undervalued Films! These terms and conditions outline the rules and regulations for the use of our website, undervaluedfilms.com.</p>
  
      <h2>1. User Data</h2>
  
      <p>1.1. Undervalued Films may collect and store user information for the purpose of providing personalized and enhanced services.</p>
      ...
      <p>2.1. By using undervaluedfilms.com, you agree not to engage in any activity that may:</p>
      ...
      <p>3.1. By providing your contact information, you consent to receive promotional information related to Undervalued Films.</p>
      ...
      <p>4.1. Undervalued Films reserves the right to revise these terms and conditions at any time without prior notice. By using this website, you agree to be bound by the current version of these terms and conditions.</p>

      <h2>5. Governing Law</h2>

      <p>5.1. These terms and conditions are governed by and construed in accordance with the laws of Australia.</p>

      <p>5.2. If you reside outside of Australia, you agree to comply with all local laws and regulations applicable to your use of Undervalued Films. However, the governing law for any legal disputes arising from the use of this website remains the laws of Australia.</p>
  ...
  const handlePrivacyPolicyClick = () => {
    ...
    <div class="terms-content">
      <h1>Undervalued Films - Privacy Policy</h1>

      <p>Last Updated: 1st January 2024</p>

      <p>This Privacy Policy describes how Undervalued Films ("we," "us," or "our") collects, uses, and discloses your personal information when you visit our website undervaluedfilms.com ("the Website"). By using the Website, you agree to the terms and conditions of this Privacy Policy.</p>
